...
// Including this header file tests a contrived example of five currencies
// with an easily verifiable arbitage cycle.


#define NUM_CURRENCIES 5
#define INPUT_FILE_PATH "test_known.txt"
#define OUTPUT_FILE_PATH "known_results.txt"
#define TOL .0000001
using namespace std;
...
/* Representation of a node:
	...
	Tn array of edge lengths coming INTO the node:
		...
		so that all edge are alligned with their source node. Since we used strict
		inequality in our relaxation step, this does not effect the algorithm.
...
// Returns a true if graph was initialized sucessfully based on the data in exchange_rates.txt
